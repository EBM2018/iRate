define({ "api": [
        ...
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "An",
            "description": "<p>object containing all the data necessary for its creation</p>"
          }
        ]
      },
      "examples": [
        ...
        "201": [
          {
            ...
            "optional": false,
            "field": "a",
            "description": "<p>JSON object containing the created answer</p>"
          }
        ]
      }
    },
        ...
        "201": [
          {
            ...
            "optional": false,
            "field": "a",
            "description": "<p>JSON object containing the created copy</p>"
          }
        ]
      }
    },
        ...
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "An",
            "description": "<p>object with the information you want to edit.</p>"
          }
        ]
      },
      "examples": [
        ...
        "201": [
          {
            ...
            "optional": false,
            "field": "a",
            "description": "<p>JSON object containing the edited copy</p>"
          }
        ]
      }
    },
        ...
        "204": [
          {
            ...
            "optional": false,
            "field": "Empty",
            "description": "<p>date to return</p>"
          }
        ]
      }
    },
  ...
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "http://localhost:4000/api/exam/:examId/exercice"
      }
    ]
  },
  {
    "type": "delete",
    "url": "/exam/:examId/exercice/:exerciceId",
    ...
    "sampleRequest": [
      {
        "url": "http://localhost:4000/api/exam/:examId/exercice/:exerciceId"
      }
    ]
  },
  {
        ...
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "An",
            "description": "<p>object containing all the data that you want to edit</p>"
          }
        ]
      },
      "examples": [
  ...
  {
    "type": "post",
    "url": "/exam/:examId/exercice/:exerciceId/question",
    ...
    "sampleRequest": [
      {
        "url": "http://localhost:4000/api/exam/:examId/exercice/:exerciceId/question"
      }
    ]
  },
  {
    "type": "delete",
    "url": "/exam/:examId/exercice/:exerciceId/question/:questionId",
    ...
    "sampleRequest": [
      {
        "url": "http://localhost:4000/api/exam/:examId/exercice/:exerciceId/question/:questionId"
      }
    ]
  },
  {
