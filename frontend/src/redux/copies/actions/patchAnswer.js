...
export const ACTIONS = {
    SET_PATCH_ANSWER_START: 'EXAMS/SET_PATCH_ANSWER_START',
    SET_PATCH_ANSWER_SUCCESS: 'EXAMS/SET_PATCH_ANSWER_SUCCESS',
    SET_PATCH_ANSWER_FAILURE: 'EXAMS/SET_PATCH_ANSWER_FAILURE',
};
...
export const patchAnswer = (copyId,questionId,answerId,answerContent) => async dispatch => {
    dispatch(SET_PATCH_ANSWER_START());
    try {
        const answer = await CopiesRepository.patchAnswer(copyId,questionId,answerId,answerContent);
