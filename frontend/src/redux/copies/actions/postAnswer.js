...
export const ACTIONS = {
    SET_POST_ANSWER_START: 'EXAMS/SET_POST_ANSWER_START',
    SET_POST_ANSWER_SUCCESS: 'EXAMS/SET_POST_ANSWER_SUCCESS',
    SET_POST_ANSWER_FAILURE: 'EXAMS/SET_POST_ANSWER_FAILURE',
};
...
export const postAnswer = (copyId,questionId,answerContent) => async dispatch => {
    dispatch(SET_POST_ANSWER_START());
    try {
        const answer = await CopiesRepository.postAnswer(copyId,questionId,answerContent);
