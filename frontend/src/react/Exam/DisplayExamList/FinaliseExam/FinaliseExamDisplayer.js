      ...
      <div className="modal-card">
        ...
        <section className="modal-card-body">
          <p className="content">
            ...
            Attention ! Cette opération bloquera toute modification possible de celui-ci, vérifiez bien toutes les
            questions de votre examen avant de continuer.
          </p>
          <div className="field" onClick={toggleScaleCheck}>
            <input type="checkbox" name="switchScale" className="switch is-info" onChange={toggleScaleCheck}
                   checked={didChecked}/>
