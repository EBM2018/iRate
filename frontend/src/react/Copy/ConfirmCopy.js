    ...
    render() {
        return (
            <section className="section">
                <div className="box notification is-info"><p className="title">Etape de soumission</p></div>
                <div className="box">
                    ...
                    <div className="columns">
                        <div className="column is-right">
                            <div className="buttons has-addons is-right">
                                <button className="button is-medium is-info" onClick={this.props.confirmCopy}>Confirmer</button>
                            </div>
                        </div>
                    </div>
                </div>
