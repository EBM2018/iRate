                ...
                <div key={exam._id} className="content">
                  ...
                  <div className="card">
                    <header className="card-header">
                      <p className="card-header-title has-no-margin-bottom">
                        Examen: {exam.title}
                      </p>
                      <div className="card-header-icon">
                        <Link
                          ...
                          data-tooltip="Cliquez ici pour passer l'épreuve"
                        >
                          En cours
                        </Link>
                      </div>
                      ...
                      <div className="content">
                        <p className="content">
                          ...
                          <strong>
                            {exam.group
                              ? exam.group.name
                              : "Pas de groupe assigné"}
                          </strong>
                        </p>
                        <p className="content">
                          {exam.session ? "Le" : null}{" "}
                          <strong>
                            {exam.session
                              ? exam.session.date
